const gameQuotes = [
  ...
  },
  {
    ...
    quotes: [
      "Rare footage of Daigo actually angry. Hadouken. Justin's turtle style overcame Raoh and now it's on the verge of putting Daigo, down one nothing... LET'S GO JUSTIN! OOOHHH! *applause* Unbelievable. Daigo with the full parry. Evolution 2004, it's madness - it's unadulterated madness!"
    ]
  },
  {
    author: `Five Nights at Freddy's`,
    quotes: [
      "Hello, hello? Uh, I wanted to record a message for you to help you get settled in on your first night. Um, I actually worked in that office before you. I'm finishing up my last week now, as a matter of fact. So, I know it can be a bit overwhelming, but I'm here to tell you there's nothing to worry about. Uh, you'll do fine. So, let's just focus on getting you through your first week.",
